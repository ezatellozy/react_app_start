  ...
  <div class="auth_login">
      ...
      <div class="change_form">
        <div>
          ...
          >
            <form>
              <div class="mb-4">
                <input-password name="newPassword" v-model="change_form.newPassword" />
              </div>
              ...
              <button
                type="submit"
                :disabled="!meta.valid || submitLoading"
    ...
    <Teleport to="body">
      <general-notify v-show="loggedInSuccess">
        ...
        <p>
          {{ $t("HEADERS.getHelpToWriteAwillMakeAPowerOfAttorneyPrepareAhealthcare") }}
        </p>
