  ...
  <form @submit.prevent="submitChangePassword">
    <div class="grid grid-cols-12 gap-4 mb-7">
      <div class="lg:col-span-6 col-span-12">
        <label for="currentPassword" class="block mb-2 text-[#b1b8c0] text-sm">{{
      ...
      <div class="col-span-12 grid grid-cols-12 gap-4 mb-7">
        ...
        <div class="lg:col-span-6 col-span-12">
          <label for="confirmNewPassword" class="block mb-2 text-[#b1b8c0] text-sm">{{
...
async function submitChangePassword() {
  ...
  await $fetch(`${config.public.baseURL}lawyer_web/edit_password`, {
    method: "POST",
    headers: {
