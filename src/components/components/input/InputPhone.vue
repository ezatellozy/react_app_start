<template>
  <div>
    <VeeField :name="name" v-model="value" v-slot="{ field, meta }">
      ...
      >
        <label for="phone_nubmer" class="label">{{ $t("labels.phoneNubmer") }}</label>

        <div class="phone_wrapper_content relative flex items-center">
          <div class="me-2 static cursor-pointer" @click="show = !show" v-if="country">
            ...
            <div id="dropdown_menu" class="dropdown_menu z-30" :class="{ active: show }">
